...
Printrun. If not, see <http://www.gnu.org/licenses/>."""
    ...
    def _add_settings(self, size):
        ...
        self.settings._add(ComboSetting("uimode", _("Standard"), [_("Standard")], _("Interface mode"), _("Standard interface is a one-page, three columns layout with controls/visualization/log"), "UI"), self.reload_ui)
        ...
        self.settings._add(HiddenSetting("last_sash_position", 50))
    ...
    def loadfile(self, event, filename = None):
        ...
        if filename is None:
            ...
            dlg.SetWildcard(_("GCODE files (*.gcode;*.gco;*.g)|*.gcode;*.gco;*.g|OBJ, STL, and GCODE files (*.gcode;*.gco;*.g;*.stl;*.STL;*.obj;*.OBJ)|*.gcode;*.gco;*.g;*.stl;*.STL;*.obj;*.OBJ|OBJ, STL files (*.stl;*.STL;*.obj;*.OBJ)|*.stl;*.STL;*.obj;*.OBJ|All Files (*.*)|*.*"))
            try:

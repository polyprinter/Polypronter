...
class Settings(object):
    ...
    def __init__(self, root):
        ...
        self._add(SpinSetting("temperature_abs", 250, 0, 400, _("Extruder temperature for ABS"), _("Extruder temp for ABS (deg C)"), "Printer"))
        ...
        self._add(SpinSetting("z_feedrate", 300, 0, 50000, _("Z manual feedrate"), _("Feedrate for Control Panel Moves in Z (mm/min)"), "Printer"))
        self._add(SpinSetting("e_feedrate", 300, 0, 1000, _("E manual feedrate"), _("Feedrate for Control Panel Moves in Extrusions (mm/min)"), "Printer"))
        self._add(StringSetting("slicecommand", "", _("Slice command"), _("Slice command"), "External"))
        self._add(StringSetting("sliceoptscommand", "", _("Slicer options command"), _("Slice settings command"), "External"))
